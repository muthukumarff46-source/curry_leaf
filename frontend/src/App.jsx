        ...
        <div className="min-h-screen bg-[#fffdf9] flex flex-col">
          ...
          <footer className="bg-[#24221d] text-stone-200 mt-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
              <div><img src={getImageUrl('/curryleaf-logo.jpeg')} alt="CurryLeaf Essential" className="w-28 h-20 object-contain mix-blend-screen mb-3" /><p className="text-sm text-stone-400 leading-6">Pure, handpicked pantry essentials rooted in India's rich spice heritage.</p><div className="flex gap-3 mt-5"><Instagram className="h-4 w-4" /><Facebook className="h-4 w-4" /></div></div>
